...
class HATModel(SRModel):
    ...
    def tile_process(self):
        """Primero recortará las imágenes de entrada en mosaicos (tiles), y luego se procesará cada mosaico.
        Finalmente, todos los mosaicos procesados se combinarán en una sola imagen.
        """
